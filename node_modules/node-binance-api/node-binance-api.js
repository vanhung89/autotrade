...
LIMIT_MAKER
    ...
    const balanceData = function(data) {
        ...
        for ( let obj of data.balances ) {
            if(obj.asset === 'BTC' || obj.asset === 'ETH' || (obj.asset !== 'BTC' && obj.asset !== 'ETH' && (obj.free > 1 || obj.locked > 1))){
				balances[obj.asset] = {available:obj.free, onOrder:obj.locked, isTrade:'', stopLoss:0, pair :'', buyPrice: 0};
			}
        }
        return balances;
    };
